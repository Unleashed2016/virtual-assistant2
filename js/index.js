...
$(document).ready(function () {
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
    messenger.send("I need to see a doc, I am feeling very sic.");
  }, 4500);
  ...
  setTimeout(() => {
    messenger.recieve("Do you need immediate attention or want to speak to someone?");
      ...
      setTimeout(() => {
    messenger.send("No, I can walk.");
  }, 11000);

  setTimeout(() => {
    messenger.recieve("I suggest you walk into a nearby clinic and speak to a GP. Let me grab a list of GPs close to you that are open.");
  }, 15000);

  setTimeout(() => {
    messenger.recieve("I've found location of three GPs near you. You can view the locations using augmented reality interface by clicking here.");
  }, 19500);
